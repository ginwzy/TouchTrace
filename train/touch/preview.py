...
from touch.features import swipe_angle_bucket
from touch.generate import GenerateOptions, TouchStep, default_data_path, default_onnx_path, generate_touch_path, load_session
...
def _swipes_from_val(data_path: Path, seed: int = 42) -> list[tuple[str, tuple[float, float], tuple[float, float]]]:
    from touch.eval import _load_val_swipes
